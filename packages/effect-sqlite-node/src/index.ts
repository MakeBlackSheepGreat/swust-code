...
export const TypeId: TypeId = "~@swust-code/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@swust-code/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@swust-code/effect-sqlite-node/NodeSqliteClient")
