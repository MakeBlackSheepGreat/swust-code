...
const releaseId = process.env.SWUST_CODE_RELEASE
if (!releaseId) throw new Error("SWUST_CODE_RELEASE is required")

const version = process.env.SWUST_CODE_VERSION
if (!version) throw new Error("SWUST_CODE_VERSION is required")
