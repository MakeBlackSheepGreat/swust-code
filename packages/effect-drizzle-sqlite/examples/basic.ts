...
class Database extends Context.Service<Database, DatabaseShape>()("@swust-code/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@swust-code/example/UserStore") {
