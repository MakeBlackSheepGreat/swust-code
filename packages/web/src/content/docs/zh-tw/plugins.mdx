...
- `.swust-code/plugins/` - 專案級外掛
- `~/.config/swust-code/plugins/` - 全域外掛
...
**npm 外掛**在啟動時使用 Bun 自動安裝。套件及其相依套件會快取在 `~/.cache/swust-code/node_modules/` 中。
...
1. 全域設定 (`~/.config/swust-code/swust-code.json`)
2. 專案設定 (`swust-code.json`)
3. 全域外掛目錄 (`~/.config/swust-code/plugins/`)
4. 專案外掛目錄 (`.swust-code/plugins/`)
