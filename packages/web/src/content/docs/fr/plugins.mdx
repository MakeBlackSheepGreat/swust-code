...
- `.swust-code/plugins/` - Plugins au niveau du projet
- `~/.config/swust-code/plugins/` - Plugins globaux
...
Les **plugins npm** sont installés automatiquement à l'aide de Bun au démarrage. Les packages et leurs dépendances sont mis en cache dans `~/.cache/swust-code/node_modules/`.
...
1. Configuration globale (`~/.config/swust-code/swust-code.json`)
2. Configuration du projet (`swust-code.json`)
3. Répertoire global des plugins (`~/.config/swust-code/plugins/`)
4. Répertoire des plugins du projet (`.swust-code/plugins/`)
