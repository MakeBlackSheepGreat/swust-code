...
Configurez les agents dans votre fichier de configuration `swust-code.json` :
...
:::tip
Avez-vous un agent que vous aimeriez partager ? [Soumettez un PR](https://github.com/MakeBlackSheepGreat/swust-code).
:::
