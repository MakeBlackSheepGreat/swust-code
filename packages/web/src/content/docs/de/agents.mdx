...
Konfigurieren Sie Agenten in Ihrer `swust-code.json`-Konfigurationsdatei:
...
- Global: `~/.config/swust-code/agents/`
- Pro Projekt: `.swust-code/agents/`

```markdown title="~/.config/swust-code/agents/review.md"
---
...
```json title="swust-code.json" {3-6,9-12}
{
  "$schema": "https://opencode.ai/config.json",
  "tools": {
    "write": true,
...
```json title="swust-code.json" {3-5,8-10}
{
  "$schema": "https://opencode.ai/config.json",
  "permission": {
    "edit": "deny"
...
```json title="swust-code.json" {6,7}
{
  "agent": {
    "deep-thinker": {
...
:::tip
Haben Sie einen Agenten, den Sie gerne teilen möchten? [Reichen Sie einen PR ein](https://github.com/MakeBlackSheepGreat/swust-code).
:::
...
```markdown title="~/.config/swust-code/agents/docs-writer.md"
---
...
```markdown title="~/.config/swust-code/agents/security-auditor.md"
---
