...
- `.swust-code/plugins/` - Plugins på projektniveau
...
**npm plugins** installeres automatisk ved hjælp af Bun ved opstart. Pakker og deres afhængigheder cachelagres i `~/.cache/swust-code/node_modules/`.
...
1. Global konfiguration (`~/.config/swust-code/swust-code.json`)
2. Projektkonfiguration (`swust-code.json`)
3. Global plugin-mappe (`~/.config/swust-code/plugins/`)
4. Projekt plugin bibliotek (`.swust-code/plugins/`)
