...
- Prosjektkonfigurasjon: `.swust-code/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/swust-code/skills/<name>/SKILL.md`
...
Den laster alle matchende `skills/*/SKILL.md` i `.swust-code/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/swust-code/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.swust-code/skills/git-release/SKILL.md` slik:
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `swust-code.json`:
...
**For innebygde agenter** (i `swust-code.json`):
