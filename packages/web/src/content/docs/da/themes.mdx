...
2. **Brugerkonfigurasjonskatalog** - Definert i `~/.config/swust-code/themes/*.json` eller `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Prosjektrotkatalog** - Definert i `<project-root>/.swust-code/themes/*.json`
4. **Nuværende arbejdskatalog** - Definert i `./.swust-code/themes/*.json`
