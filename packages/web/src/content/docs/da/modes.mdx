...
- `edit` - Kan ikke ændre eksisterende filer, undtagen filer placeret på `.swust-code/plans/*.md` for at detaljere selve planen
...
Konfigurer tilstande i din `swust-code.json`-konfigurationsfil:
...
- Globalt: `~/.config/swust-code/modes/`
...
Opret tilstandsfiler i `.swust-code/modes/` for projektspecifikke tilstande eller `~/.config/swust-code/modes/` for globale tilstande:
