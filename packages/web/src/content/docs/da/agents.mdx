...
Konfigurer agent i din `swust-code.json`-konfigurationsfil:
...
- Globalt: `~/.config/swust-code/agents/`
- Pr. projekt: `.swust-code/agents/`
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/MakeBlackSheepGreat/swust-code).
:::
