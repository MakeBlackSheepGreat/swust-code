...
هيّئ الوكلاء في ملف إعدادات `swust-code.json`:
...
- عام: `~/.config/swust-code/agents/`
- لكل مشروع: `.swust-code/agents/`
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/MakeBlackSheepGreat/swust-code).
:::
