...
- `.swust-code/plugins/` - إضافات على مستوى المشروع
- `~/.config/swust-code/plugins/` - إضافات عامة
...
**إضافات npm** تُثبَّت تلقائيا باستخدام Bun عند بدء التشغيل. تُخزَّن الحزم واعتمادياتها مؤقتا في `~/.cache/swust-code/node_modules/`.
...
1. إعدادات عامة (`~/.config/swust-code/swust-code.json`)
2. إعدادات المشروع (`swust-code.json`)
3. دليل الإضافات العام (`~/.config/swust-code/plugins/`)
4. دليل إضافات المشروع (`.swust-code/plugins/`)
