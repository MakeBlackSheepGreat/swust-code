...
- `edit` - لا يمكن تعديل الملفات الموجودة، باستثناء الملفات الموجودة في `.swust-code/plans/*.md` لتفصيل الخطة نفسها
...
قم بإعداد الأوضاع في ملف الإعدادات `swust-code.json` لديك:
...
- عالمي: `~/.config/swust-code/modes/`
- للمشروع: `.swust-code/modes/`
...
أنشئ ملفات الأوضاع في `.swust-code/modes/` لأوضاع خاصة بالمشروع أو في `~/.config/swust-code/modes/` لأوضاع عالمية:
