...
2. **Configure authentication** using one of the following methods:
   ...
   ***
   ...
   For project-specific or persistent configuration, use `swust-code.json`:
...
`swust-code.json` file. It is also recommended to disable session sharing.
...
4. Create or update your `swust-code.json` file in your project directory:
