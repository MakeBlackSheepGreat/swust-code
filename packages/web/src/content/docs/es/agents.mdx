...
Configure agentes en su archivo de configuración `swust-code.json`:
...
- Por proyecto: `.swust-code/agents/`
...
:::tip
¿Tiene un agente que le gustaría compartir? [Enviar un PR](https://github.com/MakeBlackSheepGreat/swust-code).
:::
