...
- `edit` - No se pueden modificar archivos existentes, excepto los archivos ubicados en `.swust-code/plans/*.md` para detallar el plan en sí.
...
Configure los modos en su archivo de configuración `swust-code.json`:
...
Cree archivos de modo en `.swust-code/modes/` para modos específicos del proyecto o `~/.config/swust-code/modes/` para modos globales:
