...
2. **User config directory** - Defined in `~/.config/swust-code/themes/*.json` or `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Project root directory** - Defined in the `<project-root>/.swust-code/themes/*.json`
4. **Current working directory** - Defined in `./.swust-code/themes/*.json`
