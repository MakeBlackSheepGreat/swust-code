...
Skonfiguruj agenta w pliku `swust-code.json`:
...
- Globalnie: `~/.config/swust-code/agents/`
- W projekcie: `.swust-code/agents/`
...
:::tip
Masz agenta, którym warto się podzielić? [Prześlij PR](https://github.com/MakeBlackSheepGreat/swust-code).
:::
