...
- `.swust-code/plugins/` - Wtyczki na poziomie projektu
- `~/.config/swust-code/plugins/` - Wtyczki globalne
...
**wtyczki npm** są instalowane automatycznie przy użyciu Bun podczas uruchamiania. Pakiety i ich zależności są buforowane w `~/.cache/swust-code/node_modules/`.
...
1. Konfiguracja globalna (`~/.config/swust-code/swust-code.json`)
2. Konfiguracja projektu (`swust-code.json`)
3. Globalny katalog wtyczek (`~/.config/swust-code/plugins/`)
4. Katalog wtyczek projektu (`.swust-code/plugins/`)
