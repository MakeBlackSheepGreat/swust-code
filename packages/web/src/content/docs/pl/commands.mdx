...
Utwórz `.swust-code/commands/test.md`:

```md title=".swust-code/commands/test.md"
---
...
Możesz zdefiniować polecenia w `swust-code.json` lub w plikach w katalogu `commands/`.
...
```json title="swust-code.jsonc" {4-12}
{
...
- Globalnie: `~/.config/swust-code/commands/`
- Na projekt: `.swust-code/commands/`

```markdown title="~/.config/swust-code/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".swust-code/commands/component.md"
---
...
```md title=".swust-code/commands/create-file.md"
---
...
```md title=".swust-code/commands/analyze-coverage.md"
---
...
```md title=".swust-code/commands/review-changes.md"
---
...
```md title=".swust-code/commands/review-component.md"
---
