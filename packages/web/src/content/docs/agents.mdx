...
Configure agents in your `swust-code.json` config file:
...
:::tip
Do you have an agent you'd like to share? [Submit a PR](https://github.com/MakeBlackSheepGreat/swust-code).
:::
