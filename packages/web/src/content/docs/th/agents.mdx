...
กำหนดค่าเอเจนต์ในไฟล์ `swust-code.json` ของคุณ:
...
- ระดับผู้ใช้ (Global): `~/.config/swust-code/agents/`
- ระดับโปรเจ็กต์: `.swust-code/agents/`
...
:::tip
คุณมีเอเจนต์เจ๋งๆ ที่ต้องการแบ่งปันหรือไม่? [ส่ง PR มาที่นี่](https://github.com/MakeBlackSheepGreat/swust-code)
:::
