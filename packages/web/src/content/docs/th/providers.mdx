...
ใน `~/.local/share/swust-code/auth.json`.
...
2. **กำหนดค่าการตรวจสอบสิทธิ์** โดยใช้วิธีใดวิธีหนึ่งต่อไปนี้:
   ...
   สำหรับการกำหนดค่าเฉพาะโครงการหรือแบบถาวร ให้ใช้ `swust-code.json`:
...
`swust-code.json` ไฟล์. ขอแนะนำให้ปิดใช้งานการแชร์เซสชันด้วย
...
4. สร้างหรืออัปเดตไฟล์ `swust-code.json` ของคุณในไดเร็กทอรีโครงการของคุณ:
...
4. สร้างหรืออัปเดตไฟล์ `swust-code.json` ในไดเรกทอรีโครงการของคุณ:
