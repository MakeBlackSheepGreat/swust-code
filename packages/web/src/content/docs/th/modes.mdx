...
- `edit` - ​​ไม่สามารถแก้ไขไฟล์ที่มีอยู่ได้ ยกเว้นไฟล์ที่อยู่ใน `.swust-code/plans/*.md` เพื่อดูรายละเอียดแผนงาน
...
กำหนดค่าโหมดในไฟล์กำหนดค่า `swust-code.json` ของคุณ:
...
- ทั่วโลก: `~/.config/swust-code/modes/`
- โครงการ: `.swust-code/modes/`
...
สร้างไฟล์โหมดใน `.swust-code/modes/` สำหรับโหมดเฉพาะโครงการหรือ `~/.config/swust-code/modes/` สำหรับโหมดทั่วโลก:
