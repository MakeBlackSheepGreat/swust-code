...
2. **Configura l'autenticazione** usando uno dei seguenti metodi:
   ...
   ***
   ...
   Per configurazione specifica del progetto o persistente, usa `swust-code.json`:
...
file `swust-code.json`. Si raccomanda anche di disabilitare la condivisione sessioni.
...
Personalizza tramite `swust-code.json`:
...
4. Crea o aggiorna il tuo file `swust-code.json` nella directory del progetto:
