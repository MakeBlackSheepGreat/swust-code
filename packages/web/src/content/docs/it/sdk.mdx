...
Puoi passare un oggetto di configurazione per personalizzare il comportamento. L'istanza legge comunque `swust-code.json`, ma puoi sovrascrivere o aggiungere configurazione inline:
