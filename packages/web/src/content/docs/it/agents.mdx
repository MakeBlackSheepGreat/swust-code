...
Configura gli agenti nel file `swust-code.json`:
...
- Globale: `~/.config/swust-code/agents/`
- Per progetto: `.swust-code/agents/`
...
:::tip
Hai un agente che vorresti condividere? [Invia una PR](https://github.com/MakeBlackSheepGreat/swust-code).
:::
