...
Agent'ları `swust-code.json` yapılandırma dosyanızda yapılandırın:
...
- Proje başına: `.swust-code/agents/`
...
:::tip
Paylaşmak istediğiniz bir agent'ınız var mı? [Submit a PR](https://github.com/MakeBlackSheepGreat/swust-code).
:::
