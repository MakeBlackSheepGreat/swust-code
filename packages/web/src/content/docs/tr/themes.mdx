...
2. **Kullanıcı yapılandırma dizini** - `~/.config/swust-code/themes/*.json` veya `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Proje kök dizini** - `<project-root>/.swust-code/themes/*.json`
4. **Geçerli çalışma dizini** - `./.swust-code/themes/*.json`
