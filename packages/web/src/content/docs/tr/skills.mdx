...
- Proje konfigurasyonu: `.swust-code/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/swust-code/skills/<name>/SKILL.md`
...
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.swust-code/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/swust-code/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.swust-code/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
`swust-code.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`swust-code.json` icinde):
