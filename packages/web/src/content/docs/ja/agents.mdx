...
`swust-code.json` 設定ファイルでエージェントを構成します。
...
- グローバル: `~/.config/swust-code/agents/`
- プロジェクトごと: `.swust-code/agents/`
...
:::tip
共有したいエージェントはいますか? [PR](https://github.com/MakeBlackSheepGreat/swust-code) を送信します。
:::
