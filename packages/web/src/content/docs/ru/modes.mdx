...
- `edit` – невозможно изменить существующие файлы, за исключением файлов, расположенных по адресу `.swust-code/plans/*.md`, для детализации самого плана.
...
Настройте режимы в файле конфигурации `swust-code.json`:
...
- Глобальный: `~/.config/swust-code/modes/`
- Проект: `.swust-code/modes/`
...
Создайте файлы режимов в `.swust-code/modes/` для режимов, специфичных для проекта, или в `~/.config/swust-code/modes/` для глобальных режимов:
