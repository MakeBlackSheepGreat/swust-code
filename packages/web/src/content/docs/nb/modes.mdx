...
- `edit` - Kan ikke endre eksisterende filer, bortsett fra filer som ligger på `.swust-code/plans/*.md` for å detaljere selve planen
...
Konfigurer moduser i din `swust-code.json` konfigurasjonsfil:
...
Opprett modusfiler i `.swust-code/modes/` for prosjektspesifikke moduser eller `~/.config/swust-code/modes/` for globale moduser:
