...
- `.swust-code/plugins/` - Programtillegg på prosjektnivå
...
**npm-plugins** installeres automatisk ved hjelp av Bun ved oppstart. Pakker og deres avhengigheter er bufret i `~/.cache/swust-code/node_modules/`.
...
1. Global konfigurasjon (`~/.config/swust-code/swust-code.json`)
2. Prosjektkonfigurasjon (`swust-code.json`)
3. Global plugin-katalog (`~/.config/swust-code/plugins/`)
4. Prosjektpluginkatalog (`.swust-code/plugins/`)
