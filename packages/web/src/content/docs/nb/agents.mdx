...
Konfigurer agenter i konfigurasjonsfilen `swust-code.json`:
...
- Per prosjekt: `.swust-code/agents/`
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/MakeBlackSheepGreat/swust-code).
:::
