...
2. **Brukerkonfigurasjonskatalog** - Definert i `~/.config/swust-code/themes/*.json` eller `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Prosjektrotkatalog** - Definert i `<project-root>/.swust-code/themes/*.json`
4. **Gjeldende arbeidskatalog** - Definert i `./.swust-code/themes/*.json`
