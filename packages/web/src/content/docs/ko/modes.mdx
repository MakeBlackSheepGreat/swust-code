...
- `edit` - `.swust-code/plans/*.md`에 위치한 파일을 제외하고 기존 파일을 수정할 수 없습니다.
- `patch` - 패치 적용
...
- 글로벌: `~/.config/swust-code/modes/`
- 프로젝트: `.swust-code/modes/`
...
프로젝트 별 모드 또는 `~/.config/swust-code/modes/`의 모드 파일을 만들 수 있습니다.
