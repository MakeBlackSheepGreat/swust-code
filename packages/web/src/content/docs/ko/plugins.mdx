...
- `.swust-code/plugins/` - 프로젝트 레벨 플러그인
- `~/.config/swust-code/plugins/` - 글로벌 플러그인
...
**npm 플러그인**은 시작시 Bun을 사용하여 자동으로 설치됩니다. 패키지와 그 의존성은 `~/.cache/swust-code/node_modules/`에 캐시됩니다.
...
1. 글로벌 구성 (`~/.config/swust-code/swust-code.json`)
2. 프로젝트 구성 (`swust-code.json`)
3. 글로벌 플러그인 디렉토리 (`~/.config/swust-code/plugins/`)
4. 프로젝트 플러그인 디렉토리 (`.swust-code/plugins/`)
