...
- `.swust-code/plugins/` - Project-level plugins
- `~/.config/swust-code/plugins/` - Global plugins
...
**npm plugins** are installed automatically using Bun at startup. Packages and their dependencies are cached in `~/.cache/swust-code/node_modules/`.
...
3. Global plugin directory (`~/.config/swust-code/plugins/`)
4. Project plugin directory (`.swust-code/plugins/`)
