...
- `edit` - Não pode modificar arquivos existentes, exceto para arquivos localizados em `.swust-code/plans/*.md` para detalhar o plano em si
...
Configure os modos no seu arquivo de configuração `swust-code.json`:
...
Crie arquivos de modo em `.swust-code/modes/` para modos específicos do projeto ou `~/.config/swust-code/modes/` para modos globais:
