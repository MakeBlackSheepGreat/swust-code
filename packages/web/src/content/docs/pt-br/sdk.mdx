...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `swust-code.json`, mas você pode substituir ou adicionar configuração inline:
