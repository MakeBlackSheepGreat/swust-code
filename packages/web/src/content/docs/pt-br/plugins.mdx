...
- `.swust-code/plugins/` - Plugins em nível de projeto
- `~/.config/swust-code/plugins/` - Plugins globais
...
**Plugins npm** são instalados automaticamente usando Bun na inicialização. Pacotes e suas dependências são armazenados em cache em `~/.cache/swust-code/node_modules/`.
...
1. Configuração global (`~/.config/swust-code/swust-code.json`)
2. Configuração do projeto (`swust-code.json`)
3. Diretório de plugins global (`~/.config/swust-code/plugins/`)
4. Diretório de plugins do projeto (`.swust-code/plugins/`)
