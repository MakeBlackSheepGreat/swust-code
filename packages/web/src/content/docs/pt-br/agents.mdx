...
Configure os agentes em seu arquivo de configuração `swust-code.json`:
...
:::tip
Você tem um agente que gostaria de compartilhar? [Envie um PR](https://github.com/MakeBlackSheepGreat/swust-code).
:::
