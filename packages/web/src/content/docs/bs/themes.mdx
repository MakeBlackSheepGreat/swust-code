...
2. **Korisnicki config direktorij** - `~/.config/swust-code/themes/*.json` ili `$XDG_CONFIG_HOME/opencode/themes/*.json`
3. **Korijenski direktorij projekta** - `<project-root>/.swust-code/themes/*.json`
4. **Trenutni radni direktorij** - `./.swust-code/themes/*.json`
