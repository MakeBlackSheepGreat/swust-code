...
Konfigurirajte agente u svom konfiguracijskom fajlu `swust-code.json`:
...
- Globalno: `~/.config/swust-code/agents/`
- Po projektu: `.swust-code/agents/`
...
:::tip
Imate li agenta kojeg biste željeli podijeliti? [Pošalji PR](https://github.com/MakeBlackSheepGreat/swust-code).
:::
