...
- `edit` - Ne mogu modificirati postojeće fajlove, osim fajlova koji se nalaze na `.swust-code/plans/*.md` radi detaljiziranja samog plana
...
Konfigurirajte načine rada u svom `swust-code.json` konfiguracijskom fajlu:
...
- Globalno: `~/.config/swust-code/modes/`
- Projekat: `.swust-code/modes/`
...
Kreirajte fajlove načina u `.swust-code/modes/` za specifične načine rada ili `~/.config/swust-code/modes/` za globalne načine:
