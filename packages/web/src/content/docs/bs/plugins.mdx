...
- `.swust-code/plugins/` - Dodaci na nivou projekta
- `~/.config/swust-code/plugins/` - Globalni dodaci
...
**npm dodaci** se instaliraju automatski pomoću Bun pri pokretanju. Paketi i njihove zavisnosti su keširani u `~/.cache/swust-code/node_modules/`.
...
1. Globalna konfiguracija (`~/.config/swust-code/swust-code.json`)
2. Konfiguracija projekta (`swust-code.json`)
3. Globalni direktorij dodataka (`~/.config/swust-code/plugins/`)
4. Direktorij dodataka projekta (`.swust-code/plugins/`)
