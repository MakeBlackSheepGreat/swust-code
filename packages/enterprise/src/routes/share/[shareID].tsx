import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@swust-code/sdk/v2"
import { SessionTurn } from "@swust-code/ui/session-turn"
import { SessionReview } from "@swust-code/ui/session-review"
import { DataProvider } from "@swust-code/ui/context"
import { FileComponentProvider } from "@swust-code/ui/context/file"
import { WorkerPoolProvider } from "@swust-code/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@swust-code/ui/logo"
...
import { Tabs } from "@swust-code/ui/tabs"
import { MessageNav } from "@swust-code/ui/message-nav"
import { FileSSR } from "@swust-code/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@swust-code/ui/pierre/worker").then((m) => ({
