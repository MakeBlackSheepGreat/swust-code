...
import { type Model } from "@swust-code/llm"
import * as AnthropicMessages from "@swust-code/llm/protocols/anthropic-messages"
import * as OpenAICompatibleChat from "@swust-code/llm/protocols/openai-compatible-chat"
import * as OpenAIResponses from "@swust-code/llm/protocols/openai-responses"
import { Auth, type AnyRoute } from "@swust-code/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@swust-code/v2/SessionRunnerModel") {}
