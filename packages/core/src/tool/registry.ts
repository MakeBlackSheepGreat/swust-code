...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@swust-code/llm"
...
export class Service extends Context.Service<Service, Interface>()("@swust-code/v2/ToolRegistry") {}
