...
export class Service extends Context.Service<Service, Interface>()("@swust-code/v2/FileSystem/Search") {}
...
export const defaultLayer = Layer.unwrap(
  Effect.sync(() => (Flag.SWUST_CODE_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)),
)
