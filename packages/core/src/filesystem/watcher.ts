...
declare const SWUST_CODE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof SWUST_CODE_LIBC === "undefined" ? undefined : SWUST_CODE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@swust-code/v2/FileWatcher") {}

export const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.SWUST_CODE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.SWUST_CODE_EXPERIMENTAL_FILEWATCHER) {
