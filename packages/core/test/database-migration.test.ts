...
import { DatabaseMigration } from "@swust-code/core/database/migration"
import { migrations } from "@swust-code/core/database/migration.gen"
import sessionUsageMigration from "@swust-code/core/database/migration/20260510033149_session_usage"
import normalizeStoragePathsMigration from "@swust-code/core/database/migration/20260601010001_normalize_storage_paths"
import sessionMessageProjectionOrderMigration from "@swust-code/core/database/migration/20260603040000_session_message_projection_order"
import eventSourcedSessionInputMigration from "@swust-code/core/database/migration/20260604172448_event_sourced_session_input"
import contextEpochAgentMigration from "@swust-code/core/database/migration/20260605042240_add_context_epoch_agent"
import simplifyIntegrationCredentialsMigration from "@swust-code/core/database/migration/20260611192811_lush_chimera"
...
import { SessionSchema } from "@swust-code/core/session/schema"
import { SessionTable } from "@swust-code/core/session/sql"
import sessionMetadataMigration from "@swust-code/core/database/migration/20260511173437_session-metadata"
