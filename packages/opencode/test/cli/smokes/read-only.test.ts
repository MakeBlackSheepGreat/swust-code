...
describe("opencode read-only commands (smoke)", () => {
  ...
  // SWUST_CODE_CONFIG_CONTENT={} we provide, no servers should be configured
  ...
  // `session list` reads the session DB. Fresh SWUST_CODE_TEST_HOME means
  ...
  // in production it'd be a path under SWUST_CODE_TEST_HOME / XDG_DATA_HOME.
