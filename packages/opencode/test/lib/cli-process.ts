...
//   - SWUST_CODE_CONFIG_CONTENT      : provider config inline, no files to find
//   - SWUST_CODE_TEST_HOME           : pins os.homedir() → tmpdir
//   - SWUST_CODE_DISABLE_PROJECT_CONFIG : skip walking up for swust-code.json
//   - SWUST_CODE_PURE                : skip external plugin discovery + install
//   - SWUST_CODE_DISABLE_AUTOUPDATE / AUTOCOMPACT / MODELS_FETCH : no background work
...
function isolatedEnv(home: string, configJson: string): Record<string, string> {
  return {
    SWUST_CODE_TEST_HOME: home,
    HOME: home,
    XDG_CONFIG_HOME: path.join(home, ".config"),
    XDG_DATA_HOME: path.join(home, ".local/share"),
    XDG_STATE_HOME: path.join(home, ".local/state"),
    XDG_CACHE_HOME: path.join(home, ".cache"),
    SWUST_CODE_CONFIG_CONTENT: configJson,
    SWUST_CODE_DISABLE_PROJECT_CONFIG: "1",
    SWUST_CODE_PURE: "1",
    SWUST_CODE_DISABLE_AUTOUPDATE: "1",
    SWUST_CODE_DISABLE_AUTOCOMPACT: "1",
    SWUST_CODE_DISABLE_MODELS_FETCH: "1",
    SWUST_CODE_AUTH_CONTENT: "{}",
  }
}
