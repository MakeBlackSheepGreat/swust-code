...
describe("WorkflowTool run", () => {
  ...
  const originalFlag = Flag.SWUST_CODE_EXPERIMENTAL_WORKFLOW_TOOL
  beforeAll(() => {
    Flag.SWUST_CODE_EXPERIMENTAL_WORKFLOW_TOOL = true
  })
  afterAll(() => {
    Flag.SWUST_CODE_EXPERIMENTAL_WORKFLOW_TOOL = originalFlag
  })
