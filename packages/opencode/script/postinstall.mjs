...
const base = `swust-code-${platform}-${arch}`
const sourceBinary = platform === "windows" ? "swust-code.exe" : "swust-code"
const targetBinary = path.join(__dirname, "bin", "swust-code.exe")
