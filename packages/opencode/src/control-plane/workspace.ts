...
import { EventSequenceTable, EventTable } from "@swust-code/core/event/sql"
...
export class Service extends Context.Service<Service, Interface>()("@swust-code/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        SWUST_CODE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
