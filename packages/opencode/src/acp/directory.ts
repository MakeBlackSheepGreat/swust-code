...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@swust-code/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@swust-code/ACPDirectory") {}
