...
import type { AssistantMessage as SwustCodeAssistantMessage, Message } from "@swust-code/sdk/v2"
...
export type AssistantTokenCost = Pick<SwustCodeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<SwustCodeAssistantMessage, "role"> &
  Partial<Pick<SwustCodeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@swust-code/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@swust-code/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@swust-code/ACPUsage") {}
