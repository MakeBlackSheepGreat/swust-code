...
import { AccountStateTable, AccountTable } from "@swust-code/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@swust-code/AccountRepo") {}
