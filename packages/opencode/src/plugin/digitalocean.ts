...
<html>
  <head>
    <meta charset="utf-8" />
    <title>SWUST Code - DigitalOcean Authorization</title>
    <style>
    ...
    <script>
      (async function() {
        ...
        try {
          ...
          msgEl.textContent = "You can close this window and return to SWUST Code."
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. SWUST Code will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
