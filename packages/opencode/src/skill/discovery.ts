...
import { httpClient, path } from "@swust-code/core/effect/layer-node-platform"
...
export class Service extends Context.Service<Service, Interface>()("@swust-code/SkillDiscovery") {}
