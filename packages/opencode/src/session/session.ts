...
import { Slug } from "@swust-code/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@swust-code/llm"
...
import { NonNegativeInt, optionalOmitUndefined } from "@swust-code/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".swust-code", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@swust-code/Session") {}
