...
import { llmClient } from "@swust-code/core/effect/layer-node-platform"
...
import type { LLMEvent } from "@swust-code/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@swust-code/llm/route"
import type { LLMClientService } from "@swust-code/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@swust-code/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @swust-code/llm. It
