import type { JsonSchema, LLMRequest, ProviderMetadata } from "@swust-code/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@swust-code/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @swust-code/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
