import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@swust-code/llm"
...
// Move this extraction into @swust-code/llm when Copilot is handled by the native runtime.
