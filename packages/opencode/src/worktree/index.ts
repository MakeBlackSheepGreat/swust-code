...
import { path } from "@swust-code/core/effect/layer-node-platform"
...
import type { ProjectV2 } from "@swust-code/core/project"
...
export class Service extends Context.Service<Service, Interface>()("@swust-code/Worktree") {}
