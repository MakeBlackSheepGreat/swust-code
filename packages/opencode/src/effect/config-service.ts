 ...
 *   "@swust-code/ServerAuthConfig",
 *   {
 *     password: Config.string("SWUST_CODE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("SWUST_CODE_SERVER_USERNAME").pipe(Config.withDefault("opencode")),
 *   },
 * ) {}
 *
