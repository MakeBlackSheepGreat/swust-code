...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 龙山灵码 即表示你同意我们的",
  ...
  "tui.tips.mcp_oauth": "龙山灵码 自动处理需要鉴权的远程 MCP 服务器的 OAuth",
  ...
  "tui.tips.formatter": "龙山灵码 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.lsp": "龙山灵码 使用 LSP 服务器进行智能代码分析",
  ...
  "tui.tips.plugin_protect": "写一个插件阻止 龙山灵码 读取敏感文件",
  ...
  "tui.tips.serve": "运行 {highlight}swust-code serve{/highlight} 以无头模式提供 龙山灵码 API",
  ...
  "tui.tips.github_trigger": "在 GitHub issue/PR 中输入 {highlight}/swust-code{/highlight} 触发 AI 操作",
  ...
  "tui.tips.docker": "运行 {highlight}docker run -it --rm ghcr.io/makeblacksheepgreat/swust-code{/highlight} 使用容器化版本",
  ...
  "tui.command.subagent.settings.title": "子智能体设置",
  ...
  "tui.dialog.subagent.title": "子智能体设置",
  "tui.dialog.subagent.detail.title": "子智能体",
  "tui.dialog.subagent.empty": "没有可见子智能体",
  "tui.dialog.subagent.default": "默认",
  "tui.dialog.subagent.model": "模型",
  "tui.dialog.subagent.model.title": "选择子智能体模型",
  "tui.dialog.subagent.variant": "思考强度",
  "tui.dialog.subagent.variant.title": "选择思考强度",
  "tui.dialog.subagent.variant.none": "当前模型没有可用变体",
  "tui.dialog.subagent.steps": "最大步数",
  "tui.dialog.subagent.steps.title": "设置最大步数",
  "tui.dialog.subagent.steps.placeholder": "正整数，留空表示默认",
  "tui.dialog.subagent.steps.invalid": "最大步数必须是正整数",
  "tui.dialog.subagent.clear": "清除覆盖设置",
  "tui.dialog.subagent.saved": "子智能体设置已保存",
  ...
  "tui.toast.update_available.success": "已更新到 龙山灵码 v{{version}}，请重启应用。",
  ...
  "tui.sidebar.context.window.caption": "最近一次助手请求用量",
  "tui.sidebar.context.tokens": "tokens",
  "tui.sidebar.context.breakdown.prompt": "提示词",
  ...
  "tui.sidebar.context.metric.session_tokens": "会话",
  "tui.sidebar.context.metric.requests": "请求",
  "tui.sidebar.context.metric.duration": "耗时",
  "tui.sidebar.context.metric.tps": "速度",
  "tui.sidebar.context.metric.turn_tokens": "本轮",
  "tui.sidebar.context.metric.prompt_tokens": "提示词",
  "tui.sidebar.context.runtime.title": "运行状态",
  "tui.sidebar.context.cost.title": "费用与缓存",
  ...
  "tui.sidebar.context.status.title": "状态",
  "tui.sidebar.context.status.model": "模型",
  "tui.sidebar.context.status.context": "上下文",
  "tui.sidebar.context.status.compaction": "压缩",
  "tui.sidebar.context.status.compact_trigger": "触发线",
  "tui.sidebar.context.health.empty": "空",
  "tui.sidebar.context.health.good": "良好",
  "tui.sidebar.context.health.busy": "忙碌",
  "tui.sidebar.context.health.high": "偏高",
  "tui.sidebar.context.health.full": "已满",
  "tui.sidebar.context.compaction.idle": "空闲",
  "tui.sidebar.context.compaction.soon": "将近",
  "tui.sidebar.context.compaction.needed": "需要",
  ...
  "tui.command.prompt.paste_image.title": "粘贴剪贴板图片",
  "tui.command.prompt.paste_image.description": "从剪贴板附加图片",
  "tui.prompt.paste_image.no_image": "剪贴板中未找到图片",
  ...
  "cli.providers.mimo_free.usage_hint": "无需登录，直接运行 swust-code 即可使用。如需付费/更高级模型，可重新选择 MiMo 浏览器登录。",
  ...
  "tui.command.init.description": "引导创建或更新 AGENTS.md",
  "tui.command.review.description": "审查改动，可指定 commit / branch / PR，默认审查未提交改动",
  "tui.command.dream.title": "Dream 知识整合",
  "tui.command.dream.description": "从记忆文件和近期会话中整合可长期保留的项目知识",
  "tui.command.distill.title": "Distill 技能发现",
  "tui.command.distill.description": "发现重复工作流，并打包为可复用技能、子智能体或命令",
  "tui.command.goal.title": "设定自治目标",
  "tui.command.goal.description": "设定停止条件目标；可用 /goal clear 中止",
  "tui.command.deep_research.description": "运行多来源、带事实核验的深度研究报告",
