export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using SWUST Code, you agree to our ",
  ...
  "tui.tips.github_trigger": "Use {highlight}/swust-code{/highlight} in GitHub issues/PRs to trigger AI actions",
  ...
  "tui.tips.docker": "Run {highlight}docker run -it --rm ghcr.io/makeblacksheepgreat/swust-code{/highlight} for containerized use",
  ...
  "tui.command.subagent.settings.title": "SubAgent Settings",
  ...
  "tui.dialog.subagent.title": "SubAgent Settings",
  "tui.dialog.subagent.detail.title": "SubAgent",
  "tui.dialog.subagent.empty": "No visible subagents",
  "tui.dialog.subagent.default": "Default",
  "tui.dialog.subagent.model": "Model",
  "tui.dialog.subagent.model.title": "Select subagent model",
  "tui.dialog.subagent.variant": "Reasoning",
  "tui.dialog.subagent.variant.title": "Select reasoning",
  "tui.dialog.subagent.variant.none": "No variants available for this model",
  "tui.dialog.subagent.steps": "Max steps",
  "tui.dialog.subagent.steps.title": "Set max steps",
  "tui.dialog.subagent.steps.placeholder": "Positive integer, empty for default",
  "tui.dialog.subagent.steps.invalid": "Max steps must be a positive integer",
  "tui.dialog.subagent.clear": "Clear overrides",
  "tui.dialog.subagent.saved": "Subagent settings saved",
  ...
  "tui.toast.update_available.success": "Successfully updated to SWUST Code v{{version}}. Please restart the application.",
  ...
  "tui.sidebar.context.window.caption": "Latest assistant request usage",
  ...
  "tui.sidebar.context.metric.session_tokens": "Session",
  "tui.sidebar.context.metric.requests": "Requests",
  "tui.sidebar.context.metric.duration": "Duration",
  "tui.sidebar.context.metric.tps": "Speed",
  "tui.sidebar.context.metric.turn_tokens": "Turn",
  "tui.sidebar.context.metric.prompt_tokens": "Prompt",
  "tui.sidebar.context.runtime.title": "Runtime",
  "tui.sidebar.context.cost.title": "Cost & cache",
  ...
  "tui.sidebar.context.status.title": "Status",
  "tui.sidebar.context.status.model": "Model",
  "tui.sidebar.context.status.context": "Context",
  "tui.sidebar.context.status.compaction": "Compaction",
  "tui.sidebar.context.status.compact_trigger": "Trigger",
  "tui.sidebar.context.health.empty": "Empty",
  "tui.sidebar.context.health.good": "Good",
  "tui.sidebar.context.health.busy": "Busy",
  "tui.sidebar.context.health.high": "High",
  "tui.sidebar.context.health.full": "Full",
  "tui.sidebar.context.compaction.idle": "Idle",
  ...
  "tui.command.prompt.paste_image.title": "Paste clipboard image",
  "tui.command.prompt.paste_image.description": "Attach an image from the clipboard",
  "tui.prompt.paste_image.no_image": "No image found in the clipboard",
  ...
  "cli.providers.mimo_free.usage_hint": "No login required — just run swust-code. For paid/premium models, choose MiMo browser login instead.",
  ...
  // SWUST commands (init/review/dream/distill/goal/memory)
  "tui.command.init.description": "Guided AGENTS.md setup",
  "tui.command.review.description": "Review changes; accepts commit, branch, or PR, and defaults to uncommitted changes",
  "tui.command.dream.title": "Dream Knowledge Consolidation",
  "tui.command.dream.description": "Consolidate durable project knowledge from memory files and recent sessions",
  "tui.command.distill.title": "Distill Skill Discovery",
  "tui.command.distill.description": "Find repeated workflows and package them as reusable skills, subagents, or commands",
  "tui.command.goal.title": "Set Autonomous Goal",
  "tui.command.goal.description": "Set a stop-condition goal; use /goal clear to abort",
  "tui.command.deep_research.description": "Run a deep, multi-source, fact-checked research report",
