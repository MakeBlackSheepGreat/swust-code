...
export const dict = {
  ...
  "tui.home.agreement.prefix": "SWUST Code をご利用いただくことで、",
  ...
  "tui.tips.mcp_oauth": "SWUST Code は認証が必要なリモート MCP サーバの OAuth を自動処理します",
  ...
  "tui.tips.formatter": "SWUST Code は prettier、gofmt、ruff などでファイルを自動整形します",
  ...
  "tui.tips.lsp": "SWUST Code はインテリジェントなコード解析に LSP サーバを使います",
  ...
  "tui.tips.plugin_protect": "プラグインを書いて SWUST Code が機密ファイルを読まないようにできます",
  "tui.tips.run": "{highlight}swust-code run{/highlight} で非対話的なスクリプト実行ができます",
  "tui.tips.continue": "{highlight}swust-code --continue{/highlight} で前回のセッションを再開します",
  "tui.tips.attach_cli": "{highlight}swust-code run -f file.ts{/highlight} で CLI からファイルを添付できます",
  "tui.tips.format_json": "{highlight}--format json{/highlight} を使うとスクリプトで機械可読な出力を得られます",
  "tui.tips.serve": "{highlight}swust-code serve{/highlight} を実行するとヘッドレスで SWUST Code API にアクセスできます",
  "tui.tips.attach_server": "{highlight}swust-code run --attach{/highlight} で起動中のサーバに接続します",
  "tui.tips.upgrade": "{highlight}swust-code upgrade{/highlight} で最新バージョンに更新します",
  "tui.tips.auth_list": "{highlight}swust-code auth list{/highlight} で設定済みプロバイダを確認します",
  "tui.tips.agent_create": "{highlight}swust-code agent create{/highlight} でガイド付きエージェント作成を行います",
  "tui.tips.github_trigger": "GitHub の issue/PR で {highlight}/swust-code{/highlight} を入力すると AI を起動します",
  "tui.tips.github_install": "{highlight}swust-code github install{/highlight} で GitHub workflow を設定します",
  ...
  "tui.tips.debug_config": "{highlight}swust-code debug config{/highlight} で設定の問題を調査します",
  ...
  "tui.tips.docker":
    "{highlight}docker run -it --rm ghcr.io/makeblacksheepgreat/swust-code{/highlight} でコンテナ版を実行できます",
  ...
  "tui.toast.update_available.success": "SWUST Code v{{version}} に更新しました。アプリケーションを再起動してください。",
  ...
  "cli.providers.mimo_free.usage_hint":
    "ログイン不要 — そのまま swust-code を実行できます。有料/上位モデルを利用する場合は MiMo ブラウザログインを選択してください。",
