...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 龙山灵码 即表示你同意我們的",
  ...
  "tui.tips.config_files":
    "建立 {highlight}swust-code.json{/highlight} 用於伺服器端設定，{highlight}tui.json{/highlight} 用於 TUI 設定",
  "tui.tips.global_config": "把 TUI 設定放在 {highlight}~/.config/swust-code/tui.json{/highlight} 作為全域設定",
  ...
  "tui.tips.mcp_oauth": "龙山灵码 自動處理需要驗證的遠端 MCP 伺服器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.swust-code/command/{/highlight} 加入 {highlight}.md{/highlight} 檔案以定義可重用自訂提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.swust-code/agent/{/highlight} 加入 {highlight}.md{/highlight} 檔案來建立專用 AI 角色",
  ...
  "tui.tips.formatter": "龙山灵码 自動使用 prettier、gofmt、ruff 等格式化檔案",
  ...
  "tui.tips.lsp": "龙山灵码 使用 LSP 伺服器進行智慧程式碼分析",
  "tui.tips.custom_tool":
    "在 {highlight}.swust-code/tools/{/highlight} 建立 {highlight}.ts{/highlight} 檔案定義新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定義可呼叫 Python、Go 等指令稿",
  "tui.tips.plugins":
    "在 {highlight}.swust-code/plugin/{/highlight} 加入 {highlight}.ts{/highlight} 檔案掛載事件勾點",
  "tui.tips.plugin_notify": "用外掛在工作階段完成時傳送系統通知",
  "tui.tips.plugin_protect": "撰寫一個外掛阻止 龙山灵码 讀取敏感檔案",
  "tui.tips.run": "用 {highlight}swust-code run{/highlight} 進行非互動式指令稿呼叫",
  "tui.tips.continue": "用 {highlight}swust-code --continue{/highlight} 繼續上一個工作階段",
  "tui.tips.attach_cli": "用 {highlight}swust-code run -f file.ts{/highlight} 透過命令列附加檔案",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在指令稿中取得機器可讀輸出",
  "tui.tips.serve": "執行 {highlight}swust-code serve{/highlight} 以無介面模式提供 龙山灵码 API",
  "tui.tips.attach_server": "用 {highlight}swust-code run --attach{/highlight} 連線到正在執行的服務",
  "tui.tips.upgrade": "執行 {highlight}swust-code upgrade{/highlight} 升級到最新版本",
  "tui.tips.auth_list": "執行 {highlight}swust-code auth list{/highlight} 檢視所有已設定的供應商",
  "tui.tips.agent_create": "執行 {highlight}swust-code agent create{/highlight} 引導式建立智慧代理",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中輸入 {highlight}/swust-code{/highlight} 觸發 AI 操作",
  "tui.tips.github_install": "執行 {highlight}swust-code github install{/highlight} 設定 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.swust-code/themes/{/highlight} 目錄下建立 JSON 主題檔案",
  ...
  "tui.tips.debug_config": "執行 {highlight}swust-code debug config{/highlight} 排查設定問題",
  ...
  "tui.tips.docker": "執行 {highlight}docker run -it --rm ghcr.io/makeblacksheepgreat/swust-code{/highlight} 使用容器化版本",
  "tui.tips.zen": "搭配 SWUST Code 使用 {highlight}/connect{/highlight} 選用經過測試的精選模型",
  ...
  "tui.command.subagent.settings.title": "子智慧代理設定",
  ...
  "tui.dialog.subagent.title": "子智慧代理設定",
  "tui.dialog.subagent.detail.title": "子智慧代理",
  "tui.dialog.subagent.empty": "沒有可見子智慧代理",
  "tui.dialog.subagent.default": "預設",
  "tui.dialog.subagent.model": "模型",
  "tui.dialog.subagent.model.title": "選擇子智慧代理模型",
  "tui.dialog.subagent.variant": "思考強度",
  "tui.dialog.subagent.variant.title": "選擇思考強度",
  "tui.dialog.subagent.variant.none": "目前模型沒有可用變體",
  "tui.dialog.subagent.steps": "最大步數",
  "tui.dialog.subagent.steps.title": "設定最大步數",
  "tui.dialog.subagent.steps.placeholder": "正整數，留空表示預設",
  "tui.dialog.subagent.steps.invalid": "最大步數必須是正整數",
  "tui.dialog.subagent.clear": "清除覆寫設定",
  "tui.dialog.subagent.saved": "子智慧代理設定已儲存",
  ...
  "tui.toast.update_available.success": "已更新到 龙山灵码 v{{version}}，請重新啟動應用程式。",
  ...
  "tui.command.prompt.paste_image.title": "貼上剪貼簿圖片",
  "tui.command.prompt.paste_image.description": "從剪貼簿附加圖片",
  "tui.prompt.paste_image.no_image": "剪貼簿中未找到圖片",
  ...
  "trust.capabilities": "SWUST Code 將能夠讀取、編輯和執行此目錄中的檔案。",
  ...
  "tui.command.init.description": "引導建立或更新 AGENTS.md",
  "tui.command.review.description": "審查改動，可指定 commit / branch / PR，預設審查未提交改動",
  "tui.command.dream.title": "Dream 知識整合",
  "tui.command.dream.description": "從記憶檔案和近期工作階段中整合可長期保留的專案知識",
  "tui.command.distill.title": "Distill 技能發現",
  "tui.command.distill.description": "發現重複工作流程，並打包為可複用技能、子智慧代理或命令",
  "tui.command.goal.title": "設定自治目標",
  "tui.command.goal.description": "設定停止條件目標；可用 /goal clear 中止",
  "tui.command.deep_research.description": "執行多來源、帶事實核驗的深度研究報告",
  "tui.command.memory.title": "搜尋記憶",
  "tui.command.memory.description": "搜尋持久化的專案知識",
  "tui.command.providers_import.title": "匯入憑證",
  "tui.command.providers_import.description": "從 Claude Code / 環境變數匯入 API Key",
