...
import { normalizePromptContent } from "@swust-code/tui/editor"
...
import { SWUST_CODE_BASE_MODE, useBindings } from "@swust-code/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close SWUST Code" } satisfies SlashOption,
    ]
