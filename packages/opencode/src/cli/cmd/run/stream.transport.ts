...
import type { Event, GlobalEvent, OpencodeClient } from "@swust-code/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@swust-code/RunStreamTransport") {}
