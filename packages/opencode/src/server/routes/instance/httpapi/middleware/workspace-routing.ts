...
>()("@swust-code/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@swust-code/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.SWUST_CODE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.SWUST_CODE_WORKSPACE_ID) : undefined
}
