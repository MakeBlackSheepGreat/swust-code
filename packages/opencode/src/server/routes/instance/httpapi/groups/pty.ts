import { Pty } from "@swust-code/core/pty"
import { PtyTicket } from "@swust-code/core/pty/ticket"
import { PtyID } from "@swust-code/core/pty/schema"
      ...
      .add(
        ...
        HttpApiEndpoint.get("list", PtyPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all active pseudo-terminal (PTY) sessions managed by SWUST Code.",
          }),
        ),
