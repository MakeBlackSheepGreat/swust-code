...
import { Hash } from "@swust-code/core/util/hash"
...
import { optionalOmitUndefined } from "@swust-code/core/schema"
...
const BUNDLED_PROVIDERS: Record<string, () => Promise<(opts: any) => BundledSDK>> = {
  ...
  "@ai-sdk/github-copilot": () =>
    import("@swust-code/core/github-copilot/copilot-provider").then((m) => m.createOpenaiCompatible),
    ...
    "snowflake-cortex": Effect.fnUntraced(function* (input: Info) {
      ...
      if (!account || !pat) {
        ...
        return {
          ...
          async getModel() {
            throw new Error(
              `Snowflake Cortex: missing credentials (${missing}). Set via env var, swust-code auth, or provider options.`,
            )
          },
        }
      }
...
export class Service extends Context.Service<Service, Interface>()("@swust-code/Provider") {}
