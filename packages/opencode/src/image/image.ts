...
export class Service extends Context.Service<Service, Interface>()("@swust-code/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __SWUST_CODE_PHOTON_WASM_PATH?: string }).__SWUST_CODE_PHOTON_WASM_PATH =
