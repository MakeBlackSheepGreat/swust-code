...
import defaultSoundPath from "@swust-code/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@swust-code/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@swust-code/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@swust-code/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@swust-code/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@swust-code/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "SWUST Code"
