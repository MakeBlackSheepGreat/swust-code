...
export function DialogExportOptions(props: DialogExportOptionsProps) {
  ...
  useBindings(() => ({
    bindings: [
      {
        key: "tab",
        desc: t("tui.dialog.export.next_option"),
        group: t("tui.command.category.dialog"),
        cmd: () => {
  ...
  useBindings(() => ({
    ...
    bindings: [
      {
        key: "space",
        desc: t("tui.dialog.export.toggle_option"),
        group: t("tui.command.category.dialog"),
        cmd: () => {
    ...
    <box paddingLeft={2} paddingRight={2} gap={1}>
      ...
      <box flexDirection="column">
        ...
        >
          ...
          <text fg={store.active === "thinking" ? theme.primary : theme.text}>{t("tui.dialog.export.include_thinking")}</text>
        </box>
        <box
          flexDirection="row"
          gap={2}
        ...
        >
          ...
          <text fg={store.active === "toolDetails" ? theme.primary : theme.text}>{t("tui.dialog.export.include_tool_details")}</text>
        </box>
        <box
          flexDirection="row"
          gap={2}
        ...
        >
          ...
          <text fg={store.active === "assistantMetadata" ? theme.primary : theme.text}>{t("tui.dialog.export.include_assistant_metadata")}</text>
        </box>
        <box
          flexDirection="row"
          gap={2}
        ...
        >
          ...
          <text fg={store.active === "openWithoutSaving" ? theme.primary : theme.text}>{t("tui.dialog.export.open_without_saving")}</text>
        </box>
      </box>
