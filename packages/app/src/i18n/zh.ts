...
export const dict = {
  ...
  "dialog.provider.swust-code.note": "使用 OpenCode Zen 或 API 密钥连接",
  "dialog.provider.swust-code.tagline": "可靠的优化模型",
  "dialog.provider.swust-codeGo.tagline": "适合所有人的低成本订阅",
  ...
  "provider.connect.swust-codeZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.swust-codeZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.swust-codeZen.visit.prefix": "访问 ",
  "provider.connect.swust-codeZen.visit.link": "swust-code.ai/zen",
  "provider.connect.swust-codeZen.visit.suffix": " 获取你的 API 密钥。",
  ...
  "dialog.plugins.empty": "在 swust-code.json 中配置的插件",
  ...
  "error.chain.checkConfig": "请检查你的配置 (swust-code.json) 中的 provider/model 名称",
