export const dict = {
  ...
  "dialog.provider.swust-code.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.swust-code.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.swust-codeGo.tagline": "Недорога підписка для всіх",
  ...
  "provider.connect.swust-codeZen.visit.prefix": "Відвідайте ",
  "provider.connect.swust-codeZen.visit.link": "swust-code.ai/zen",
  "provider.connect.swust-codeZen.visit.suffix": ", щоб отримати ключ API.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в swust-code.json",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (swust-code.json)",
