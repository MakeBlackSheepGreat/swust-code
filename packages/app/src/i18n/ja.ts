export const dict = {
  ...
  "dialog.provider.swust-code.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.swust-code.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.swust-codeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "provider.connect.swust-codeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.swust-codeZen.visit.prefix": " ",
  "provider.connect.swust-codeZen.visit.link": "swust-code.ai/zen",
  "provider.connect.swust-codeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "dialog.plugins.empty": "swust-code.jsonで設定されたプラグイン",
  ...
  "error.chain.checkConfig": "config (swust-code.json) のプロバイダー/モデル名を確認してください",
