...
export const dict = {
  ...
  "dialog.provider.swust-code.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.swust-code.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.swust-codeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "provider.connect.swust-codeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.swust-codeZen.visit.link": "swust-code.ai/zen",
  "provider.connect.swust-codeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  ...
  "dialog.plugins.empty": "In swust-code.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (swust-code.json) auf Anbieter-/Modellnamen",
