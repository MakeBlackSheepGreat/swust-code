export const dict = {
  ...
  "dialog.provider.swust-code.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.swust-code.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.swust-codeGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "provider.connect.swust-codeZen.visit.prefix": "Odwiedź ",
  "provider.connect.swust-codeZen.visit.link": "swust-code.ai/zen",
  "provider.connect.swust-codeZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w swust-code.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (swust-code.json) nazwy dostawców/modeli",
