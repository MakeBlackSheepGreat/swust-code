export const dict = {
  ...
  "dialog.provider.swust-code.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.swust-code.tagline": "Reliable optimized models",
  "dialog.provider.swust-codeGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.swust-codeZen.visit.prefix": "Visit ",
  "provider.connect.swust-codeZen.visit.link": "swust-code.ai/zen",
  "provider.connect.swust-codeZen.visit.suffix": " to collect your API key.",
  ...
  "dialog.plugins.empty": "Plugins configured in swust-code.json",
  ...
  "wsl.onboarding.step.swust-code": "OpenCode",
  ...
  "wsl.onboarding.swust-codeReadyIn": "OpenCode is ready in {{distro}}.",
  "wsl.onboarding.swust-codeReady": "OpenCode is ready.",
  ...
  "error.chain.checkConfig": "Check your config (swust-code.json) provider/model names",
