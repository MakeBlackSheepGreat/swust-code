export const dict = {
  ...
  "dialog.provider.swust-code.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.swust-code.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.swust-codeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "provider.connect.swust-codeZen.visit.prefix": "Visite ",
  "provider.connect.swust-codeZen.visit.link": "swust-code.ai/zen",
  "provider.connect.swust-codeZen.visit.suffix": " para obter sua chave de API.",
  ...
  "dialog.plugins.empty": "Plugins configurados em swust-code.json",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (swust-code.json)",
