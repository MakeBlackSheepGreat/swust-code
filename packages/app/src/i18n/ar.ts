export const dict = {
  ...
  "dialog.provider.swust-code.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.swust-code.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.swust-codeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "provider.connect.swust-codeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.swust-codeZen.visit.link": "swust-code.ai/zen",
  "provider.connect.swust-codeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في swust-code.json",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (swust-code.json)",
