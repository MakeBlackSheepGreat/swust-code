...
import { Tag } from "@swust-code/ui/v2/badge-v2"
import { ButtonV2 } from "@swust-code/ui/v2/button-v2"
import { Dialog } from "@swust-code/ui/v2/dialog-v2"
import { Icon as IconV2 } from "@swust-code/ui/v2/icon"
import { IconButtonV2 } from "@swust-code/ui/v2/icon-button-v2"
import { MenuV2 } from "@swust-code/ui/v2/menu-v2"
...
import { wslSwustCodeAction, wslRuntimeRetryable } from "./settings-model"
    ...
    <Show when={api}>
      <For each={props.servers()}>
        {(item) => {
          ...
          const check = () => wsl.data?.swustCodeChecks[item.config.distro]
          const opencodeAction = () => wslSwustCodeAction(check())
