...
beforeAll(async () => {
  ...
  mock.module("@swust-code/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@swust-code/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@swust-code/ui/icon", () => ({ Icon: () => null }))
  mock.module("@swust-code/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
