...
import { Tooltip, TooltipKeybind } from "@swust-code/ui/tooltip"
...
import { ProjectAvatar } from "@swust-code/ui/v2/project-avatar-v2"
...
function ChannelIndicator() {
  return (
    <>
      {["beta", "dev"].includes(import.meta.env.VITE_SWUST_CODE_CHANNEL) && (
        <div class="bg-icon-interactive-base text-[#FFF] font-medium px-2 rounded-sm uppercase font-mono">
          {import.meta.env.VITE_SWUST_CODE_CHANNEL.toUpperCase()}
        </div>
      )}
    </>
  )
