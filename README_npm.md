...
Source code is licensed under the [MIT License](https://github.com/MakeBlackSheepGreat/swust-code/blob/main/LICENSE).

Use of SWUST Code is also subject to the [Use Restrictions](https://github.com/MakeBlackSheepGreat/swust-code/blob/main/USE_RESTRICTIONS.md).
